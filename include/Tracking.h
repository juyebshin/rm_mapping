...
public:
    ...
    cv::Mat GrabImageStereo(const cv::Mat &imRectLeft,const cv::Mat &imRectRight,const cv::Mat &labelRectLeft,const cv::Mat &labelRectRight, const double &timestamp, RoadMarking *pRoadMark, const cv::Mat &Q);
