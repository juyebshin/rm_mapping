...
//        cout << "Viewer: (" << mViewpointX << ", " << mViewpointY << ", "
//             << mViewpointZ << ", " << mViewpointF << ")" << endl;
        ...
        else if(menuStart && !bStart)
        {
            // inform System to start
            mpSystem->Start();
            bStart = true;
            menuStart = false;
        }
        ...
        if(bStart && menuPause)
        {
            // inform System to pause
            mpSystem->Pause();
            bStart = false;
            menuPause = false;
        }
        else if(!bStart && menuPause)
        {
            menuPause = false;
        }
